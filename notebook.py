...
#we're creating a correaltion matrix only on song characteristics
#we're using echonest because it has more data than the merged echo_tracks
...
tree_score = cross_val_score(tree, train_features, train_labels, cv=10)
logit_score = cross_val_score(logreg, train_features, train_labels, cv=10)
