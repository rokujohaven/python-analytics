...
ax = hourly.plot.bar()
ax.set(xlabel='hour', ylabel='# of tests', title='# of tests by hour')
...
ax = monthly.plot.bar()
ax.set(xlabel = 'month', ylabel ='# of tests', title="# of tests by month")
...
# unstack and plot
timeline.unstack().plot(title='VEISHEA DUIs', legend=True).set(xlabel='week', ylabel='count')
