...
cap10 = cap10.assign(market_cap_perc = lambda x: x.market_cap_usd/cap.market_cap_usd.sum()*100.0)
...
ax = cap10.plot.bar(y = 'market_cap_usd',title = TOP_CAP_TITLE, colors=COLORS, logy=True)
